...
import com.biao.shop.common.exception.MybatisPlusException;
...
public class MysqlGenerator {
    public static String scanner(String tip) throws MybatisPlusException {
        ...
        help.append("please input ").append(tip).append(":");
    ...
    public static void main(String[] args) throws MybatisPlusException {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/vehicle_shop?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
